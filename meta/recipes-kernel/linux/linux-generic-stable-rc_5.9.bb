...
DESCRIPTION = "Generic Linux Stable RC 5.9 LTS kernel"
...
SRC_URI = "\
    git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable-rc.git;protocol=https;branch=linux-5.9.y;name=kernel \
